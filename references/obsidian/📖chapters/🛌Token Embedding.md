...
Processing sequences of embeddings and contextualizing them, is the core idea behind Transformers. Embeddings are generic and can be easily adapted to the tabular domain.  
