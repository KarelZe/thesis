...
Popular ensemble methods for trees include bagging and random forests [[@breimanRandomForests2001]]. Also, Boosting is another approach that learns a sequence base learners such as simplified decision trees. [[@tibshiraniElementsStatisticalLearning]] (p. 587) We present boosting as part of section [[draft_gbm]].
...
with $\Theta_{b}$ being a parameter vector of the  $b$-th tree [[@tibshiraniElementsStatisticalLearning]].
