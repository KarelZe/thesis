*title:* Transformer Interpretability Beyond Attention Visualisation
...
“For comparison, using the same notation, the rollout [1] method is given by: ˆ A(b) = I + EhA(b) (15) rollout = ˆ A(1) · ˆ A(2) · . . . · ˆ A(B) (16) We can observe that the result of rollout is fixed given an input sample, regardless of the target class to be visualised. In addition, it does not consider any signal, except for the pairwise attention scores.” ([Chefer et al., 2021, p. 786](zotero://select/library/items/9L5MKBEL)) ([pdf](zotero://open-pdf/library/items/LRAFWM53?page=5&annotation=4BLHCY3Z))
