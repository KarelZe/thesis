...
Resources:
- nice visualisations: https://towardsdatascience.com/master-positional-encoding-part-i-63c05d90a0c3
...
- Positional encoding can be learnt or fix. Both seem to work similarily. 
...
Visualisation of  diffferent columns:
...
-   Our model should generalise to longer sentences without any efforts. Its values should be bounded.
...
$$
\begin{align}
  0: \ \ \ \ \colour{orange}{\texttt{0}} \ \ \colour{green}{\texttt{0}} \ \ \colour{blue}{\texttt{0}} \ \ \colour{red}{\texttt{0}} & & 
  8: \ \ \ \ \colour{orange}{\texttt{1}} \ \ \colour{green}{\texttt{0}} \ \ \colour{blue}{\texttt{0}} \ \ \colour{red}{\texttt{0}} \\
  1: \ \ \ \ \colour{orange}{\texttt{0}} \ \ \colour{green}{\texttt{0}} \ \ \colour{blue}{\texttt{0}} \ \ \colour{red}{\texttt{1}} & & 
  9: \ \ \ \ \colour{orange}{\texttt{1}} \ \ \colour{green}{\texttt{0}} \ \ \colour{blue}{\texttt{0}} \ \ \colour{red}{\texttt{1}} \\ 
  2: \ \ \ \ \colour{orange}{\texttt{0}} \ \ \colour{green}{\texttt{0}} \ \ \colour{blue}{\texttt{1}} \ \ \colour{red}{\texttt{0}} & & 
  10: \ \ \ \ \colour{orange}{\texttt{1}} \ \ \colour{green}{\texttt{0}} \ \ \colour{blue}{\texttt{1}} \ \ \colour{red}{\texttt{0}} \\ 
  3: \ \ \ \ \colour{orange}{\texttt{0}} \ \ \colour{green}{\texttt{0}} \ \ \colour{blue}{\texttt{1}} \ \ \colour{red}{\texttt{1}} & & 
  11: \ \ \ \ \colour{orange}{\texttt{1}} \ \ \colour{green}{\texttt{0}} \ \ \colour{blue}{\texttt{1}} \ \ \colour{red}{\texttt{1}} \\ 
  4: \ \ \ \ \colour{orange}{\texttt{0}} \ \ \colour{green}{\texttt{1}} \ \ \colour{blue}{\texttt{0}} \ \ \colour{red}{\texttt{0}} & & 
  12: \ \ \ \ \colour{orange}{\texttt{1}} \ \ \colour{green}{\texttt{1}} \ \ \colour{blue}{\texttt{0}} \ \ \colour{red}{\texttt{0}} \\
  5: \ \ \ \ \colour{orange}{\texttt{0}} \ \ \colour{green}{\texttt{1}} \ \ \colour{blue}{\texttt{0}} \ \ \colour{red}{\texttt{1}} & & 
  13: \ \ \ \ \colour{orange}{\texttt{1}} \ \ \colour{green}{\texttt{1}} \ \ \colour{blue}{\texttt{0}} \ \ \colour{red}{\texttt{1}} \\
  6: \ \ \ \ \colour{orange}{\texttt{0}} \ \ \colour{green}{\texttt{1}} \ \ \colour{blue}{\texttt{1}} \ \ \colour{red}{\texttt{0}} & & 
  14: \ \ \ \ \colour{orange}{\texttt{1}} \ \ \colour{green}{\texttt{1}} \ \ \colour{blue}{\texttt{1}} \ \ \colour{red}{\texttt{0}} \\
  7: \ \ \ \ \colour{orange}{\texttt{0}} \ \ \colour{green}{\texttt{1}} \ \ \colour{blue}{\texttt{1}} \ \ \colour{red}{\texttt{1}} & & 
  15: \ \ \ \ \colour{orange}{\texttt{1}} \ \ \colour{green}{\texttt{1}} \ \ \colour{blue}{\texttt{1}} \ \ \colour{red}{\texttt{1}} \\
\end{align}
$$
Number in binary format. The LSB bit is alternating on every number, the second-lowest bit is rotating on every two numbers, and so on. BUT, binary encoding would be wasteful and not generalise.

- Another property of sinusoidal position encoding is that the distance between neighbouring time-steps are symmetrical and decays nicely with time.
...
$$
$\boldsymbol{P E} E_{(p o s, i)}$ represents the position encoding at position $p o s$ in the sequence, and hidden dimensionality $i$. These values, concatenated for all hidden dimensions, are added to the original input features (in the Transformer visualisation above, see "Positional encoding"), and constitute the position information. We distinguish between even $(i \bmod 2=0)$ and uneven $(i \bmod 2=1$ ) hidden dimensionalities where we apply a sine/cosine respectively. 
...
- Count through: values become really large. Weights for neural networks should be centred and balanced around zero. (See [[@lecunEfficientBackProp2012 1]])
- Count through and normalise: can no langer handle arbitrary sequence lengths
- binary encoding (encoding numbers as binary number) would result in a matrix. Can not handle large numbers which would require more places than columns in matrix. Could be centred around zero with $f(x)=2x-1$
...
- $\sin$ function exists on $[-1,1]$ and is normalised.
