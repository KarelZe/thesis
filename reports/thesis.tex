...
\usepackage[symbols,acronyms,automake,savewrites=true,toc,section=section]{glossaries}
...
%Symbols
\newglossaryentry{M}{type=symbols,name={\ensuremath{\boldsymbol{M}}},sort=M, description={a matrix}}

%Glossary
\newglossaryentry{embedding}{name={embedding},plural={embeddings},description={Numerical vector representation of the input, e.g. a word or scalar.}}
\newglossaryentry{token}{name={token},plural={tokens},description={Item in a vocbulary. For textual data, tokens can be a character, sub-word, a word. 
For tabular data, a token corresponds to a column.}}
...
\newpage
\printglossary[title={List of Symbols},type=symbols,style=listdotted]
...
% Glossary
\newpage
\printglossary[type=main,title=Glossary,style=listdotted]
\end{document}