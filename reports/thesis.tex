...
\newglossaryentry{ell}{type=symbols,name={\ensuremath{\ell}}, sort=ell, description={length of token sequence}, unit={\ensuremath{\in \mathbb{N}}}}
\newglossaryentry{ellmax}{type=symbols,name={\ensuremath{\ell_{\max}}},sort=ell-max, description={maximum sequence length}}
...
\newglossaryentry{t}{type=symbols,name={\ensuremath{t}},sort=t, description={index of token in sequence}}
\newglossaryentry{y}{type=symbols,name={\ensuremath{y}},sort=y, description={label}, unit={\ensuremath{\in \{0,1\}}}}
\newglossaryentry{X}{type=symbols,name={\ensuremath{\boldsymbol{X}}},sort=x, description={feature matrix}}
