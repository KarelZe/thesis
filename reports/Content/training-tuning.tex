...
\begin{figure}[ht]
    ...
    \subfloat[Hyperparameter Search Space of \gls{GBRT} With Feature Set 2\label{fig:ise-gbm-hyperparam-classical-size}]{\includegraphics[width=0.6\textwidth]{3vntumoi-hyperparam-search-space.pdf}}
    \vfill
    \subfloat[Hyperparameter Search Space of \gls{GBRT} With Feature Set 3\label{fig:ise-gbm-hyperparam-ml}]{\addtocounter{subfigure}{2}\includegraphics[width=0.6\textwidth]{2t5zo50f-hyperparam-search-space.pdf}}
...
\begin{figure}[!b]
    ...
    \vfill
    \subfloat[Hyperparameter Search Space of FT-Transformer With Feature Set 2\label{fig:ise-transformer-hyperparam-classical-size}]{\includegraphics[width=0.6\linewidth]{1qx3ul4j-hyperparam-search-space.pdf}}
\end{figure}
\clearpage
\begin{figure}[ht]
    \addtocounter{figure}{-1}
...
Due to the pseudo-random sampling during the first trials of Bayesian search combined with the reduced number of trials for the Transformer studies, the tested hyperparameter combinations are identical for all feature sets. Universally,
...
\begin{table}[H]
    \centering
    \sisetup{table-number-alignment=left}
    \caption[Hyperparameter Search Space of Trade Classification Rules]{Hyperparameter search space of trade classification rules. We perform \num{50} trials for each feature set.}
...
\begin{table}[H]
    \centering
    \caption[Search Solutions of Trade Classification Rule]{Search solutions of trade classification rule.}
    \label{tab:solutions-classical-rules}
    \begin{tabular}{@{}lllll@{}}
        \toprule
        Hyperparameter            & FS 1 & FS 2/3 & Grauer FS 1 & Grauer FS2/3 \\ \midrule
        Layer 1                   &      &        &  $\operatorname{quote}_{\mathrm{nbbo}}$           &              \\
        Layer 2                   &      &        & $\operatorname{quote}_{\mathrm{ex}}$            &              \\
        Layer 3                   &      &        & $\operatorname{Id}$           &              \\
        Layer 4                   &      &        &  $\operatorname{Id}$           &              \\
        Layer 5                   &      &        & $\operatorname{Id}$            &              \\ \midrule
