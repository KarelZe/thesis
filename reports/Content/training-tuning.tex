...
\begin{figure}[ht]
    ...
    \subfloat[Hyperparameter Search Space of \gls{GBRT} With Feature Set 3\label{fig:ise-gbm-hyperparam-ml}]{\addtocounter{subfigure}{2}\includegraphics[ width=0.6\linewidth]{2t5zo50f-hyperparam-search-space.pdf}}
...
The search space for the semi-supervised variant is identical to the supervised gradient boosting. To conserve space, we only report the tabulated results in \cref{tab:solutions-GBRT-self-training}. Visualisations are available online.\footnote{\todo{Research links}}
...
\begin{figure}[!b]
    \subfloat[Hyperparameter Search Space of FT-Transformer With Feature Set 1\label{fig:ise-gbm-hyperparam-classical}]{\includegraphics[ width=0.6\linewidth]{3jpe46s1-hyperparam-search-space.pdf}}
    \vfill
    \subfloat[Hyperparameter Search Space of FT-Transformer With Feature Set 2\label{fig:ise-gbm-hyperparam-classical-size}]{\includegraphics[ width=0.6\linewidth]{1qx3ul4j-hyperparam-search-space.pdf}}
\end{figure}
\clearpage
\begin{figure}[ht]
    \addtocounter{figure}{-1}
    \subfloat[Hyperparameter Search Space of FT-Transformer With Feature Set 3\label{fig:ise-gbm-hyperparam-ml}]{\addtocounter{subfigure}{2}\includegraphics[width=0.6\linewidth]{2h81aiow-hyperparam-search-space.pdf}}
    \caption[]{Hyperparameter Search Space of FT-Transformer on \gls{ISE} Validation Set}
    \label{fig:ise-fttransformer-hyperparam}
\end{figure}

\todo{Describe found solutions.}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}llSSS@{}}
        ...
        Learning rate $\eta$                 & $\operatorname{LogUniform}[\num{3e-5}, \num{3e-4}]$ &        &        &        \\
        weight decay $\lambda$               & $\operatorname{LogUniform}[\num{1e-6}, \num{1e-3}]$ &        &        &        \\ \midrule
        Validation Accuracy in \%            &                                                     & {0.0}  & {0.0}  & {0.0}  \\ \bottomrule
    \end{tabular}
\end{table}
...
Results are tabulated in \cref{tab:solutions-transformer-pretraining}. Visualisations of the hyperparameter search space are available online.\footnote{\todo{Add link to visualisations.}}
