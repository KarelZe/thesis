\begin{table}
    ...
    \begin{tabular}{lSSSSSS} % remove first l
        ...
        \midrule
        \multicolumn{1}{l}{\gls{GBM}}                                                                                                                                  \\ % manually add instead of first index level
        ...
        \tabindent GSU Method (Best, Ex)       & 59.3773           & 65.0525           & 72.7194           & 72.0256           & 72.7252           & 65.4078           \\ % manually add \tabindent
        \bottomrule
    \end{tabular}
\end{table}
