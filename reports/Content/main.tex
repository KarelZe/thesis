...
\begin{equation}
\operatorname{Accuracy} = 1 - \mathcal{L}_{0-1}(\mathbf{y}, \hat{\mathbf{y}})
\end{equation}

where $\mathcal{L}_{0-1}(\cdot)$ is the 0-1-loss given by:
\begin{equation}
\mathcal{L}_{0-1}(\mathbf{y}, \hat{\mathbf{y}}) = \frac{1}{N}\sum_{i=1}^{N}\mathbb{I}\left(\mathbf{y}_{i}\neq \hat{\mathbf{y}}_{i}\right).
\end{equation}
