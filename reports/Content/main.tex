...
In absence of other suitable baselines, we repeatedly compare against \gls{GSU} method as a baseline, even if it doesn't involve option-specific features.

% TODO: How do validation accuracies of ml approaches and classical rules compare?

\subsection{Evaluation}\label{sec:evaluation}

Subsequent sub-chapters discuss measure to retrieve feature importance estimates from the estimators and defines metrics used in evaluation.
