...
\begin{threeparttable}[H]
    \centering
    \caption[Features and Feature Sets]{Features and Feature Sets.}
...
The redundant encoding can make patterns in the data learnable but complicates attributing predictions to certain features due to substitution effects. We address this concern when determining the feature importances.
