...
% \begin{figure}[ht!]
%     \centering
%     \includegraphics{cboe-gbm-classical-search-space.pdf}
%     \caption[Visualization Of The Search Space]{Visualization of the search space. Own drawing.}
%     \label{fig:cboe-gbm-classical-search-space}
% \end{figure}
