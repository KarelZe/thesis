...
Like the attention layer, the position-wise \gls{FFN} is surrounded by residual connections (see \cref{sec:residual-connections}), followed by layer normalization (see \cref{sec:layer-norm}). Optionally, dropout \autocite[][1930]{srivastavaDropoutSimpleWay} is added to prevent the model from \gls{overfitting}.
