...
\begin{table}[H]
    \centering
    \caption[Hyperparameter Search Space of Gradient Boosting]{Hyperparameter search space of gradient boosting. The three most right columns document the best combination in terms validation accuracy per feature set. We perform \num{50} trials each.}
