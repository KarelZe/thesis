...
\begin{figure}[ht]
    ...
    \caption[Training Schemes]{Training scheme on \gls{ISE} and \gls{CBOE} sample. Train, validation set are split by time. Shaded area \mysquare{viz-gray} indicates the duration for which the dataset is available. Own work.}
