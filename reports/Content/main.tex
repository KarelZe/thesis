...
Like the quote rule, the depth rule has additional dependencies on quote data. The rule has not yet seen wide adoption.
...
Thus, we frame trade signing as a supervised, probabilistic classification task. This is similar to \textcite[][272]{easleyDiscerningInformationTrade2016}, who alter the tick rule and \gls{BVC} algorithm to obtain the probability estimates of a buy from an individual or aggregated trades, but with a sole focus on trade signing on a trade-by-trade basis and unsupervised. A probabilistic view enables a richer evaluation, but constraints the selection to probabilistic classifiers. For comparability, classical trade signing rules need to be modified to yield both the predicted class (buy or sell) and the associated class probabilities.
...
% TODO: better write logloss? Make connexion clearer?
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=14cm]{research-framework}
...
\begin{figure}[!b]
    \subfloat[Hyperparameter Search Space of \gls{GBRT} With Feature Set 1\label{fig:ise-gbm-hyperparam-classical}]{\includegraphics[ width=0.6\linewidth]{1gzk7msy-hyperparam-search-space.pdf}}
    \vfill
    \subfloat[Hyperparameter Search Space of \gls{GBRT} With Feature Set 2\label{fig:ise-gbm-hyperparam-classical-size}]{\includegraphics[ width=0.6\linewidth]{3vntumoi-hyperparam-search-space.pdf}}
\end{figure}
\clearpage
\begin{figure}[ht]
    \addtocounter{figure}{-1}
    \subfloat[Hyperparameter Search Space of \gls{GBRT} With Feature Set 3\label{fig:ise-gbm-hyperparam-ml}]{\includegraphics[ width=0.6\linewidth]{2t5zo50f-hyperparam-search-space.pdf}}
...
\begin{figure}[!b]
    \subfloat[Hyperparameter Search Space of \gls{GBRT} With Self-Training With Feature Set 1\label{fig:ise-gbm-self-training-hyperparam-classical}]{\includegraphics[ width=0.6\linewidth]{37lymmzc-hyperparam-search-space.pdf}}
    \vfill
    \subfloat[Hyperparameter Search Space of \gls{GBRT} With Self-Training With Feature Set 2\label{fig:ise-gbm-self-training-hyperparam-classical-size}]{\includegraphics[ width=0.6\linewidth]{1vmti6db-hyperparam-search-space.pdf}}
\end{figure}
...
\begin{figure}[ht]
    \addtocounter{figure}{-1}
    \subfloat[Hyperparameter Search Space of \gls{GBRT} With Self-Training With Feature Set 3\label{fig:ise-gbm-self-training-hyperparam-ml}]{\includegraphics[width=0.6\linewidth]{t55nd8r0-hyperparam-search-space.pdf}}
