...
\begin{equation}
    \operatorname{l}_{SSE}(\widehat{\mathbb{y}},\mathbb{y})=\frac{1}{N} \sum_{m \in M} \sum_{\mathbb{x}_{i} \in R_m}\left(y_{i}-c_{m}\right)^{2},
\end{equation}
...
\begin{equation}
    \min _{j, s}\left[\min _{c_1} \sum_{\mathbb{x}_i \in R_1(j, s)}\left(y_i-c_1\right)^2+\min _{c_2} \sum_{\mathbb{x}_i \in R_2(j, s)}\left(y_i-c_2\right)^2\right].
\end{equation}
