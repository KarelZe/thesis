...
\subsubsection{Tick Test (1~p)}\label{sec:tick-test}
...
\subsubsection{Ellis-Michaely-O'Hara
  Rule (0.5~p)}\label{sec:ellis-michaely-ohara-rule}
...
\subsubsection{Extensions in TabNet (2~p)}\label{sec:extensions-in-tabnet}
