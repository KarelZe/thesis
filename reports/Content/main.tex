...
\begin{table}[H]
    ...
    \begin{tabular}{llSSS}
        \toprule
        Parameter                    & Distribution                              & {FS 1}           & {FS 2}               & {FS 3}            \\ \midrule
...
The hyperparameter search for the FT-Transformer is identical to \textcite[][18]{gorishniyRevisitingDeepLearning2021} (variant (b)). 
