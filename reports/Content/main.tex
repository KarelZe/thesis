...
The subsequent sections introduce two adaptions of the classical Transformer for the
tabular domain. We start with the \emph{TabTransformer} of \textcite{huangTabTransformerTabularData2020}.

%\begin{landscape}
\begin{figure}[h]
  \subfloat[Architecture of TabTransformer. Own work.\label{fig:tabtransformer}]{%
    {\renewcommand\normalsize{\scriptsize}%
        \normalsize
        \input{./Graphs/tabtransformer.pdf_tex}}
  }
  \hfill%
  \subfloat[Architecture of FTTransformer. Own work.\label{fig:fttransformer}]{%
    {\renewcommand\normalsize{\scriptsize}%
        \normalsize
        \input{./Graphs/tabtransformer.pdf_tex}}
  }
  \caption[Comparison Between Tabular Transformers]{Comparison Between Tabular Transformer.}
