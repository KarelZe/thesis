...
\todo{As options are cross-listed across multiple exchanges, hence also traded, the rule can be estimated using the previous price at the same or from all exchanges where the option is traded.}
