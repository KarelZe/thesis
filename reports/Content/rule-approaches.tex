...
The performance of the tick rules hinges on the availability of recent trade prices for inference. For infrequently traded assets this can pose a problem, as outdated prices might loose their relevancy in classification.
...
\todo{Think about writing as restriction? \url{https://en.wikipedia.org/wiki/Restriction_(mathematics)}}
