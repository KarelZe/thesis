...
% Our classifiers deliver accurate predictions and improved robustness, which effectively
% reduces noise and bias in option research dependent on reliable trade initiator
% estimates. When applied to measuring trading cost through effective spreads,
% the models dominate all rule-based approaches by approximating the true effective
% spread of options best.
