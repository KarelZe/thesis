...
\todo{This is not entirely true, as it suggests, that low coverage of quote nbbo comes from missing data, but it comes from midspread trades. For tick rule, I can not distinguish if trade price was not found, or if it was not differnt. Rewrite.}
...
\begin{figure}[h!]
    \subfloat[Tick Rule-like Head (4,5)\label{fig:head-tick}]{\includegraphics[width=0.3\textwidth]{attention_head_5_layer_4_ise_quotes_mid.pdf}}
    \hfill
    \subfloat[Trade Size Rule-like Head (4,1)\label{fig:head-tsize}]{\includegraphics[width=0.3\textwidth]{attention_head_1_layer_4_ise_quotes_mid.pdf}}
    \hfill
    \subfloat[\glsentryshort{LR}-Like Head (4,8)\label{fig:head-lr}]{\includegraphics[width=0.3\textwidth]{attention_head_8_layer_4_ise_quotes_mid.pdf}}
