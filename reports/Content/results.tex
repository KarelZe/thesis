...
\todo{Results match the of grauer in magnitude.}
...
\todo{isolate what comes from missing data and is not limited by the rule.}
...
\begin{figure}[!h]
    ...
    \caption[Coverage Of Rule-Based Classifiers On \glsentryshort{ISE} and \glsentryshort{CBOE} Over Time]{Coverage of rule-based classifiers on \gls{ISE} and \gls{CBOE} sample over time.}
...
\begin{figure}[!h]
    ...
    \caption[Accuracy Over Trade Size Rule On \glsentryshort{ISE} and \glsentryshort{CBOE} Over Time]{Accuracy of trade size rule on \gls{ISE} and \gls{CBOE} sample over time.}
...
\todo{formulate finding, once Transformer results are ready.}
...
From our machine learning-based classifiers the FT-Transformer or \gls{GBRT} trained on \gls{FS} option provides estimates closest to the true effective spread, in particular on the \gls{CBOE} sample. The null hypothesis of equal medians is rejected at the \SI{1}{\percent} level for all classifiers.
