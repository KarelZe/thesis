...
\todo{raise the point of systematic missclassification. Systematic error vs. noise.}
...
The analysis of attention follows a top-down approach. Initially, we generate model-wide attention maps using the methodology of \textcite[][2--4]{cheferTransformerInterpretabilityAttention2021}. Subsequently, we detail the analysis by probing specific attention heads adapting a procedure of \textcite[][4]{clarkWhatDoesBERT2019}. \todo{Optionally, add figure how both approaches relate. This could be similar to a heatmap with zoom-in effect as done in \textcite{coenenVisualizingMeasuringGeometry2019}.}
