...
\begin{table}[!h]
    ...
    \begin{tabular}{@{}llSSSSSS@{}}
        \toprule
                                                                          &           & \multicolumn{2}{c}{{\gls{FS} Classical}}                          & \multicolumn{2}{c}{{\gls{FS} Classical-Size}}                      & \multicolumn{2}{c}{{\gls{FS} Option}}                                                             \\
...
\begin{table}[ht!]
    ...
    \begin{tabular}{lSSSSSS@{}}
        \toprule
        {}                       & \multicolumn{2}{c}{\gls{FS} Classical} & \multicolumn{2}{c}{\gls{FS} Classical-Size} & \multicolumn{2}{c}{\gls{FS} Option}                                        \\ \cmidrule(lr){2-3}\cmidrule(lr){4-5}\cmidrule(lr){6-7}
