...
\begin{table}[!ht]
    ...
    \caption[Summary Statistics for Labeled \glsentryshort{ISE} Full Sample]{Summary statistics for full \gls{ISE} labeled sample.}
    \label{tab:ise-summary-labeled-full}
    \begin{tabular}{@{}lSSSSSSSSS@{}}
        \toprule
        \multicolumn{3}{c}{} & \multicolumn{7}{c}{{Percentile}}                                                                                                      \\
...
\begin{table}[!h]
    \centering
    \sisetup{table-format=4.2,table-alignment-mode = none, table-number-alignment=left, table-text-alignment = left}
    \caption[Summary Statistics for Labeled \glsentryshort{CBOE} Full Sample]{Summary statistics for full \gls{CBOE} labeled sample.}
...
\begin{table}[ht!]
    \centering
    \sisetup{table-format=4.2,table-alignment-mode = none, table-number-alignment=left, table-text-alignment = left}
    \caption[Summary Statistics for Unlabeled \glsentryshort{ISE} Training Sample]{Summary statistics for \gls{ISE} unlabeled training sample.}
