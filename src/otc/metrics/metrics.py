...
def effective_spread(
    ...
    """
    Depending on mode, calculate the nominal effective spread.

    Effective spread given by:
    $$
    ...
    Args:
        ...
        mode (Literal["nominal", "relative"], optional): "nominal" or
        "relative". Defaults to "nominal".
    Returns:
